...
import type { NarrativeCardTitleBoxPosition } from '~/components/Narratives_OLD/CardForNarratives.vue'
import CardForNarratives from '~/components/Narratives_OLD/CardForNarratives.vue'

/** Posizione del box titolo per indice `i` nella lista narratives. */
